...
//+kubebuilder:rbac:groups=apps.poconetes.dev,resources=builders,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apps.poconetes.dev,resources=builders/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apps.poconetes.dev,resources=builders/finalizers,verbs=update
