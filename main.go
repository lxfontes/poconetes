...
import (
	...
	appscontrollers "github.com/lxfontes/poconetes/controllers/apps"
	tunnelscontrollers "github.com/lxfontes/poconetes/controllers/tunnels"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "76f13d42.poconetes.dev",
	})
	if err != nil {
	...
	if err = (&tunnelscontrollers.ClientReconciler{
	...
	if err = (&appscontrollers.FormationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
